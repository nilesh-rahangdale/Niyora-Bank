...
const BranchComplaints = () => {
  ...
  const managerBranchId = managerData?.branchId;
  ...
  const branchComplaints = complaints.filter((c) => 
    Number(c.branchId) === Number(managerBranchId)
  );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-1.5 border-b border-slate-800/60 pb-5">
        <h1 className="text-2xl font-bold tracking-tight text-white">Branch Complaints Ledger</h1>
...
export default BranchComplaints;
